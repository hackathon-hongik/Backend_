...
class QuestionChoices(models.TextChoices):
    Q1 = 'Q1', '중요한 대화를 해야 할 때, 갈등을 피하기 위해 어떤 준비를 하나요?'
    Q2 = 'Q2', '인간 관계에서 자신의 감정을 효과적으로 표현하는 방법은 무엇인가요?'
    Q3 = 'Q3', '책의 주요 메시지나 교훈이 내 현재 진로 고민에 어떤 통찰을 제공했나요?'
    Q4 = 'Q4', '책을 읽고 나서 내 진로에 대한 새로운 아이디어나 방향성이 생겼다면, 그것을 구체적으로 어떻게 실행할 수 있을까요?'
    Q5 = 'Q5', '책을 통해 알게 된 투자 리스크 관리 방법 중 나에게 적합한 것은 무엇이며, 그것을 어떻게 실행할 수 있을까요?'
    Q6 = 'Q6', '책에서 소개된 성공적인 재정 관리 사례를 내 삶에 적용한다면, 어떤 변화가 필요할까요?'
    Q7 = 'Q7', '이 책에서 배운 중요한 건강 관리 원칙은 무엇이며, 그것을 어떻게 내 생활에 적용할 수 있을까요?'
    Q8 = 'Q8', '책에서 소개된 성공적인 건강 관리 사례를 내 삶에 적용한다면, 어떤 변화가 필요할까요?'
    Q9 = 'Q9', '내가 직장에서 버겁게 느끼는 부분은 무엇이며, 책에서 제안한 해결책 중 어떤 것을 시도해볼 수 있을까요?'
    Q10 = 'Q10', '책을 읽고 난 후 나의 직장 업무 방식을 재구성해야 한다면, 어떤 변화가 필요하다고 생각하나요?'
